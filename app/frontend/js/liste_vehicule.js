document.addEventListener("DOMContentLoaded", function () {
  // Lors du chargement de la page, récupérer tous les véhicules
  fetch("liste_vehicules.php", {
    method: "GET", // Utilisez GET si vous ne souhaitez pas envoyer de données du formulaire
  })
